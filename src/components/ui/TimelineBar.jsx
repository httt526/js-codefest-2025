	...
	return (
		<ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical z-[2]">
			<li>
				...
				<div className="timeline-start mb-10 md:text-end text-xl">
					<time className="font-HP italic text-secondary">13/08 - 31/08</time>
					<div className="text-md md:text-2xl font-black text-primary">
						Mở đơn đăng ký
					</div>
					<p className="hidden md:block text-sm leading-[1.75rem]">
			...
			<li>
				...
				<div className="timeline-end md:mb-10 text-xl">
					...
					<p className="hidden md:block text-sm leading-[1.75rem]">
						...
						<br /> Đồng thời các đội thi sẽ phát triển và tối ưu con bot của
						riêng mình.
					</p>
				</div>
				<hr />
			...
			<li>
				...
				<div className="timeline-start mb-10 md:text-end text-xl">
					...
					<div className="text-2xl font-black text-primary">Vòng Chung kết</div>
					<p className="hidden md:block text-sm leading-[1.75rem]">

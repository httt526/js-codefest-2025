...
*/}
				<div
					className="absolute bottom-[20%] left-[12%] h-30 z-10 flex gap-[0px]"
				><CountdownTimer />
				</div>

				<Link to="https://docs.google.com/document/u/0/">
					<div>
						<div
						...
						<div className="absolute bottom-[10.6%] left-[43.2%] z-10 font-HP text-2xl text-[#ffffff] font-bold uppercase">Thể lệ cuộc thi</div>
					</div>
				</Link>

				<div className="absolute col-span-2 flex items-center justify-center font-HP text-9xl top-[44%] left-[33%] z-20" style={{WebkitTextStroke: '3px #000000', textStroke: '3px #000000'}}>
						<span className="text-[#1D2C48]" style={{WebkitTextStroke: '4px #1D2C48', textStroke: '4px #1D2C48'}}>CODE</span>
						<span className="text-[#92ACFA]" style={{ textShadow: "8px 8px #1D2C48", letterSpacing: "10px"}}>FE</span>
						<span className="text-[#92ACFA] " style={{ textShadow: "8px 8px #1D2C48"}}>ST</span>
				</div>
